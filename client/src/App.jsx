...
const App = () => (
  <BrowserRouter>
    ...
    <div className="flex justify-end gap-2 mt-1">
      <Link to="https://www.fusionwaveai.com/create-nft/" 
       ...
       className="text-white object-right bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l
        focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm sm:px-5 px-3 sm:py-2.5 py-2 text-center mr-2 mb-2">
        Mint NFT  
      </Link>
      <Link to="/create-post" 
